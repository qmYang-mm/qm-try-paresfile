...
public class GenerateNum {
     ...
     * 生成一个订单号
     */
    public synchronized String GenerateOrder(String prctType) throws Exception {
        if (StringUtils.isBlank(prctType)) {
            throw new NullPointerException("产品类型为空");
        }
